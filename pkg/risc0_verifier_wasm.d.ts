/* tslint:disable */
/* eslint-disable */
export function verify_receipt_wasm(receipt_bytes: Uint8Array, image_bytes: Uint8Array): Uint8Array;

export type InitInput = RequestInfo | URL | Response | BufferSource | WebAssembly.Module;

export interface InitOutput {
  readonly memory: WebAssembly.Memory;
  readonly verify_receipt_wasm: (a: number, b: number, c: number, d: number) => [number, number, number, number];
